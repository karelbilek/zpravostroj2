...
Varianty u klasifikátorů jsou shodné s~variantami, definovanými v~části~\ref{sec:klasifikace_priklady}. Evaluace probíhá podle \ref{sec:evaluace_klasifikace} --- tj. 10krát je množina 200 ručně zatříděných článků rozdělena na dvě množiny po 20 a 180 článcích, klasifikátory jsou poté naučeny na 180 článcích a otestovány na 20. Hodnoty $\rho$, $\pi$ a $F$ jsou potom spočítány pro každý z~těchto 10 pokusů zvlášť a nakonec zprůměrovány aritmetickým průměrem.
