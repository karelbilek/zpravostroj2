...
Metrikou, popsanou v~\ref{sec:dalsimetody}, jsem porovnal různé způsoby detekce témat; výsledky jsou uvedeny v~Tabulce~\ref{tabulka:neklas}. Jak je popsáno v~\ref{sec:dalsimetody}, tyto metody testuji na 200 ručně zatříděných článcích.
