...
Úkolem bakalářské práce je sledovat elektronické zdroje zpravodajství, na zá\-kla\-dě opakujících se slov zařazovat články do témat, tato témata sledovat v~čase a případně na základě tohoto sledování detekovat něco, jako je \uv{okurková sezóna}.
...
Výhoda zpravodajských webů je ta, že jsou za krátkou dobu (v řádu měsíců až jednotek let) stylisticky stabilní a jsou psány podobným jazykem, zároveň ale mají jasně danou časovou posloupnost. To nám daný úkol značně zjednodušuje.
...
Pro nalezení množiny témat pro daný článek potom vezmu prvních $k$ nej\-čas\-těj\-ších slov --- buď bez ohledu na stopslova, nebo s~jejich vyřazením, kde $k$ je konstantní pro celou databázi.
...
\begin{tabular}{|l || l|l|l|l|}
    \hline
    \textbf{Článek 1} & 10V & *V & 10O & *O   \\ \hline \hline
...
\multicolumn{1}{l}{} \\
  ...
  \hline
  \textbf{Článek 2} & 10V & *V & 10O & *O  \\ \hline \hline
...
\end{tabular}
}{Výsledky klasifikátorů na Článcích 1 a 2}
...
\begin{itemize}
    \item \emph{10V} nazývám tu variantu, kdy jako rysy článků beru 10 nej\-cha\-rak\-te\-ri\-sti\-čtěj\-ších slov podle TF-IDF, všechny s~konstantní vahou 1, a články zatřiďuji do \uv{ne\-o\-me\-ze\-ných} kategorií, jak popisuji v~\ref{sec:jakekategorie},
    \item \emph{*V} nazývám tu variantu, kdy jako rysy nechám \emph{všechna} slova s~jejich vahou spočítanou podle TF-IDF  a články opět zatřiďuji do \uv{neomezených} kategorií, jak popisuji v~\ref{sec:jakekategorie},
    \item \emph{10O} nazývám obměnu varianty 10V s tím, že zatřiďuji do \uv{o\-me\-ze\-ných}, obecnějších kategorií,
    \item \emph{*O} nazývám obměnu varianty *V s tím, že opět zatřiďuji do \uv{o\-me\-ze\-ných} kategorií.
\end{itemize}
...
\subsection{Neklasifikační metody}
...
\begin{tabular}{|l || r | r|r||r| r|r|}
    ...
    TF-IDF, $k=20$ & 51.72  & 7.60  & 13.25  & 6.79  & 5.95  & 6.34  \\ \hline 
    
  \end{tabular}

}{Přesnosti a úplnosti neklasifikačních metod, v procentech}

Metrikou, popsanou v~\ref{sec:dalsimetody}, jsem porovnal různé způsoby detekce témat; výsledky jsou uvedeny v~Tabulce~\ref{tabulka:neklas}. Jak je popsáno v~\ref{sec:dalsimetody}, tyto metody testuji na 200 ručně zatříděných článcích, \uv{jedním} průchodem (narozdíl od \ref{sec:evaluace_jedn_prist_klas}, kde provádím cross-evaluaci).
...
Je zajímavé, že zatímco \uv{opticky} a v~mikroprůměru jsou výsledky stop témat lepší, v~makroprůměru se výsledky zhorší.
...
\label{sec:evaluace_jedn_prist_klas}
...
\begin{tabular}{|l || r | r|r||r| r|r|}
    ...
    NaiveBayes - 10V & 13.18  & 17.13  & 14.85  & 9.01  & 5.85  & 7.04  \\ \hline
    NaiveBayes - *V & 5.36  & 5.69  & 5.50  & 4.02  & 1.19  & 1.75 \\ \hline
    SVM - 10V & 2.17  & 90.00  & 4.16  & 1.72  & 1.94  & 1.81  \\ \hline
    SVM - *V & 0.00  & 100.00  & 0.00  & 0.00  & 0.00  & 0.00 \\ \hline
    DecisionTree - 10V & 11.57  & 33.55  & 16.89  & 7.79  & 8.21  & 7.93 \\ \hline 
    DecisionTree - *V & 9.00  & 13.93  & 10.77  & 5.34  & 5.25  & 5.25  \\ \hline \hline
    
    NaiveBayes - 10O & 48.50  & 48.50  & 48.50  & 30.05  & 25.88  & 27.49  \\ \hline
    NaiveBayes - *O & 31.50  & 31.50  & 31.50  & 12.69  & 7.92  & 9.40  \\ \hline
    SVM - 10O & 16.00  & 16.00  & 16.00  & 13.75  & 14.90  & 13.33 \\ \hline
    SVM - *O &  6.00  & 6.00  & 6.00  & 7.26  & 3.71  & 4.07  \\ \hline
    
    DecisionTree - 10O & 24.50  & 24.50  & 24.50  & 16.96  & 18.75  & 17.41  \\ \hline 
    DecisionTree - *O & 33.50  & 33.50  & 33.50  & 22.43  & 23.83  & 22.82  \\ \hline
    
  \end{tabular}

}{Přesnosti a úplnosti klasifikátorů, v procentech}

Varianty u klasifikátorů jsou shodné s~variantami, definovanými v~části~\ref{sec:klasifikace_priklady}. Evaluace probíhá podle \ref{sec:evaluace_klasifikace} --- tj. 10krát je množina 200 ručně zatříděných článků rozdělena na 20 trénovacích a 180 testovacích dat, klasifikátory jsou poté naučeny na 180 článcích a otestovány na 20. Hodnoty $\rho$, $\pi$ a $F$ jsou potom spočítány pro každý z~těchto 10 pokusů zvlášť a nakonec zprůměrovány aritmetickým průměrem.
