...
}{Přesnost a úplnost detekce frekvenčních témat}
...
%Pokud otestuji tato témata pomocí metrik $F_1$, vyjdou mi tristní výsledky, které jsou uvedeny v~Tabulce ~\ref{tabulka:ftemata_eval}; je vidět, že výsledky jsou té\-měř stej\-né, jako u triviálního detekce témat.
...
}{Přesnost a úplnost detekce stoptémat}
...
}{Přesnost a úplnost detekce tf-idf témat}
