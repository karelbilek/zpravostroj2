...
kreslis2 <- function(jmeno, barva) {
	...
	lines(c(what_paint),cely_sma[c(what_paint)],type="l", col=barva, lwd=2.5);
...
kreslis2("divka", "black")
kreslis2("politika", "green")
kreslis2("demokrat", "darkorange3")
kreslis2("modelka", "magenta3")

legend(1, max, texty, col=barvy, lty=1, lwd=2.5);
